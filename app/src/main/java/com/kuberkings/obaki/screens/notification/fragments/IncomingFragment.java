...
import com.kuberkings.obaki.screens.bottomview.chat.MyMessageAdapter;
 ...
 * Use the {@link IncomingFragment#newInstance} factory method to
...
public class IncomingFragment extends Fragment {
    ...
    public static IncomingFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NotificaionAdapter notificaionAdapter = new NotificaionAdapter(view.getContext(),messages, new  NotificaionAdapter.OnMessageActionListner() {
            @Override
